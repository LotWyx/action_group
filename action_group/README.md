...
src/
  ...
  components/
    ...
    dashboard/             карточка настроек уведомлений в MAX
...
Дополнительно:
- свёрнутый календарь «ближайшие плановые даты» на главном экране;
- **уведомления в мессенджер MAX** (карточка на главном экране) — напоминание
  о приближающейся плановой дате подтверждения навыка и уведомление после
  каждой PR-встречи, см. корневой README.
